...
var matchSeekersSample: [MatchSeeker] = [
    ...
    MatchSeeker(screenName: "StarlightSam32", hobbies: "Surfing, Dancing, Swimming", gender: .female, dateOfBirth: Date.now, bio: "Hi, my name is Sam and I am working as a support worker in a disability service provider, I am positive of meeting people with disabilities.", favourteMusic: "WILLOW SMITH", datingPreference: DatingPreference(interestedIn: .men, disabilityPreference: .openMinded, discloseMyDisability: false), imageName: "women2"),
     MatchSeeker(screenName: "ben10", hobbies: "Going to the gym", gender: .male, dateOfBirth: Date.now, bio: "Hi, my name is Ben, I work at a factory packing up chocolates", favourteMusic: "Junior Jack: My feeling", datingPreference: DatingPreference(interestedIn: .men, disabilityPreference: .withDisability, discloseMyDisability: true), disability: Disability(disabilities: "Intelectual disability", severeity: .moderate), imageName: "men1"),
     ...
     MatchSeeker(screenName: "thaiCake", hobbies: "Playing guitar", gender: .transgender, dateOfBirth: Date.now, bio: "I am into dogs and cats", favourteMusic: "Wu-Tang", datingPreference: DatingPreference(interestedIn: .other, disabilityPreference: .openMinded, discloseMyDisability: false))
]
