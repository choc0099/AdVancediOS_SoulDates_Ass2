...
var matchSeekersSample: [MatchSeeker] = [
    MatchSeeker(screenName: "Erin", hobbies: "Arts, Dance, Clubbing", gender: .female, dateOfBirth: Date.now, bio: "I like to eat bake beans for breakfast and hang out with my friends at the clubs", favourteMusic: "RUFUS", interestedIn: .men),
